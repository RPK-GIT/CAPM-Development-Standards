...
**Executions:** the full execution record of 2026-08-12 (both fixtures, incl. the [Java fixture](../examples/worked-example-m3-java/README.md)) is in [validation-results-2026-08.md](validation-results-2026-08.md) — the pre-calibration base (40 scenarios) all PASSed with one defect found-and-fixed (calibration item 1). **Round 1 calibration (2026-08-12) added P9–P10, F7–F8, E6, R5–R7 (8 scenarios; the catalog is now 48); the addendum in the same results document records their execution plus re-runs of the affected pre-existing scenarios. The historical claim of *36 → 44* in that record undercounted by 4 at both endpoints — the true trajectory is 40 → 48, unchanged in ratio and coverage.** Re-run after any change to the commands, profile spec, matrix, or CAPire protocol.
