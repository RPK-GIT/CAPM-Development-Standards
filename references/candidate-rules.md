...
> **Disposition status:** the **CAP-SEC**, **CAP-MT** (Batch 1), **CAP-ARCH**, **CAP-CDS**, **CAP-SRV** (Batch 2), the **CAP-DB**, **CAP-TXN**, **CAP-EVT** (Batch 3), the **CAP-LOGIC**, **CAP-INT** (Batch 4), the **CAP-TEST**, **CAP-ERR**, **CAP-LOG** (Batch 5), and **CAP-PERF**, **CAP-EXT**, **CAP-PRIV** (Batch 6, incl. deferred CAP-SEC #17) sections below — plus cross-category items CAP-OPS #3, CAP-LOGIC #1/#5, CAP-PERF #6 — have been formally dispositioned: see [candidate-dispositions.md](candidate-dispositions.md) and the normative rules in the [rule catalog](../standards/rules/README.md). Dispositioned entries below are retained as research history; the catalog files are authoritative.
